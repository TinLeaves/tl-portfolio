  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center pt-16 relative">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:items-center gap-4 lg:gap-12">
          ...
          <div className="space-y-4 sm:space-y-6 text-center lg:text-left order-2 lg:order-1">
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-2 sm:mb-3 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">
                Steven Lai
              </h1>
